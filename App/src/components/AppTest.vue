            ...
            <div class="margin-top-4x">
              ...
              <div class="flex-row flex-center">
                ...
                <div class="width margin-right">
                  <el-input v-model="appinfo.testunicode" @change="saveheader"></el-input>
                </div>
                <div class="width-1x">TOKEN</div>
                <div class="width margin-right">
                  <el-input v-model="appinfo.testtoken" @change="saveheader"></el-input>
                </div>
                <div class="width-1x">TOKENKEY</div>
                <div class="width margin-right">
                  <el-input v-model="appinfo.testtokenkey" @change="saveheader"></el-input>
                </div>
              </div>
    ...
    <el-dialog title="编辑测试" :visible.sync="showedit" width="80%">
      <div v-if="test!=null">
        ...
        <div class="margin-top-4x text-center">
          ...
          <el-button @click="testapi" v-if="test!=null&&test.id">临时测试</el-button>
        </div>
      </div>
    </el-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    testapi() {
      ...
      HttpHelper.ApiTest(
        Config.CMSDEVApi + this.appinfo.member_yycno + "/" + this.appinfo.alias,
        inputstr.join("&"),
            ...
            for (var item of apilist) {
              ...
              if (nothave == false) {
                ...
                console.log(
                  "apitest",
                  item,
                  dataishave == false ? [] : item.data.input
                );
                testlist.push({
                  ...
                  name:
                    (dataishave == false ? "" : item.data.name) +
                    "默认接口测试",
                  summary: "",
