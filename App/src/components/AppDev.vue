    ...
    <div v-if="appinfo!=null">
      <el-tabs :tab-position="'left'" v-if="modellist.length>0">
        ...
        <el-tab-pane label="数据接口设计">
          <div class="padding-left">
            <div class="flex-row">
              <div class="flex-1 h3">数据接口设计</div>
              <div>
                <el-button type="primary" @click="opennew('/#/app/'+appinfo.alias+'/apiimmersion')">沉浸式编程</el-button>
              </div>
            </div>
            <div class="margin-top-4x">
        ...
        <el-tab-pane label="版本管理">
          <div class="padding-left">
            ...
            <div class="margin-top-4x">
              <AppDevVersion :appinfo="appinfo"></AppDevVersion></div>
          </div>
        </el-tab-pane>
      </el-tabs>
