        ...
        <div class="container bd">
          <div class="boxbg bd-bottom padding-top padding-bottom">
            ...
            <div class="flex-row text-center margin-top-1x">
              ...
              <div class="flex-1" :class="{'active':step>2}">重设账号密码</div>
              <div class="flex-1" :class="{'active':step>3}">完成重置</div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    nextsuccess:function(event){
      HttpHelper.Post("member/passwordreset", {
        mobile: this.mobile,
